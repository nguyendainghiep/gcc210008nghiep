...
public class Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnLogin.setBackground(new java.awt.Color(135, 157, 165));
        ...
        btnCancel.setBackground(new java.awt.Color(135, 157, 165));
    ...
    private void btnLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLoginActionPerformed
        ...
        if(sb.length()>0){
            JOptionPane.showMessageDialog(this, "Invalidation",
                    "Warning", HEIGHT);
            return;
        }
